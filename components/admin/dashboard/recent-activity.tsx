...
export function RecentActivity({
  ...
  const getActivityDescription = (activity: ActivityItem) => {
    switch (activity.type) {
      case "user_registration":
        return t("activity.descriptions.user_registered", {
      ...
      case "report_submitted":
        return t("activity.descriptions.report_submitted", {
          target: activity.target?.title?? "",
        });
      case "message_sent":
        return t("activity.descriptions.message_sent");
      case "listing_promoted":
        return t("activity.descriptions.listing_promoted", {
          title: activity.target?.title?? "",
        });
      case "user_verified":
        return t("activity.descriptions.user_verified");
      case "subscription_started":
        return t("activity.descriptions.subscription_started", {
          ...
          <div className="border-t pt-3 mt-3">
            <div className="text-center">
              <Button variant="outline" onClick={onViewAll}>
                {t("activity.view_all_activities", {
                  count: activities.length - maxItems,
                })}
              </Button>
            </div>
          </div>
