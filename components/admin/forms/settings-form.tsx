                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>
                            {t("settings.registration_enabled")}
                          </FormLabel>
                          <FormDescription>
              ...
              <CardContent className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("settings.cloudfront_url")} ({t("common.optional")})
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
              ...
              <CardContent className="space-y-4">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder="OLX Marketplace - Buy & Sell Everything"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("settings.og_image")} ({t("common.optional")})
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
              ...
              <CardContent className="space-y-3">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between">
                      <FormLabel>
                        {t("settings.enable_subscriptions")}
                      </FormLabel>
                      <FormControl>
                        <Switch
                          checked={field.value}
              ...
              <CardContent className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Google Analytics ID ({t("common.optional")})
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Facebook Pixel ID ({t("common.optional")})
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
